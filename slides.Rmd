...
In computation, a ‘string’ is a contiguous sequence of symbols or values. For example, a word, a date, a set of numbers (e.g., a phone number), or an alphanumeric value (e.g., an identifier).
...
`\w`, which matches any character that normally occurs inside a word 
...
1. Find the fruits with names between 10 and 12 characters.
2. Find the lines with no more than 4 letters
...
na**?** will match n or na.

na***** will match all of n, na, naaa, etc.

na**+** will match na or naaaa, for example, but not n.
